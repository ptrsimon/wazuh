...
@patch('wazuh.core.wdb.WazuhDBConnection._send', side_effect=send_msg_to_wdb)
@patch('socket.socket.connect')
def test_agent_add_agent(socket_mock, send_mock, open_mock, safe_move_mock, tempfile_mock, common_gid_mock,
                         common_uid_mock, chmod_mock, chown_mock, fcntl_mock, name, agent_id, key):
